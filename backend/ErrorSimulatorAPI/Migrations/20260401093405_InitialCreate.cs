        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReservedBalance = table.Column<decimal>(type: "decimal(65,30)", nullable: false),
            ...
            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "AccountNumber", "Balance", "CreatedAt", "Currency", "Email", "FullName", "IsActive", "ReservedBalance" },
                values: new object[,]
                {
                    { new Guid("a1b2c3d4-0000-0000-0000-000000000001"), "ACC-000001", 1000000m, new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "USD", "alice@example.com", "Alice Johnson", true, 0m },
                    { new Guid("a1b2c3d4-0000-0000-0000-000000000002"), "ACC-000002", 10000m, new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "USD", "bob@example.com", "Bob Smith", true, 0m }
                });
